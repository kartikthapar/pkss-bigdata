...
% I would put something about results here, but we don't really have any
% I guess this should do it
% Alternately just say it was a great learning experience working 
% I don't think I have anything else to add. I just did a quick proofreading pass.
% It looks fine
% Then lets turn it in.  Would you like to send it in?
%Sure I'm okay with that
% Nah, you do it
% OK
% Thanks!! :)
% Can you put the latex on github then?
% Sure
\section{References}
\begin{itemize}
\item Apache Hadoop: \\
